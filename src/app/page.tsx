  ...
  return (
    <div className={`min-h-screen bg-gray-50 ${inter.className}`}>
      ...
      <div className="w-full">
        <Image src="/image.jpg" alt="logo" width={2000} height={100} className="w-full h-auto object-cover" priority />
      </div>
      {/* Main Content */}
  ...
  return (
    <div className="group relative overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-200 transition-all duration-200 hover:shadow-lg hover:ring-gray-300">
      <Link href={href} target="_blank" className="block">
        ...
        <div className="p-4">
          <h3 className="font-bold text-lg text-gray-900 group-hover:text-gray-700 transition-colors duration-200 text-center">
            {title}
          </h3>
        </div>
      </Link>
